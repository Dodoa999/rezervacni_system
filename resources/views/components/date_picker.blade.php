<div x-data="{
      ...
      datePickerValue: '',
      datePickerFormat: 'YYYY-MM-DD',  // Nastavený formát pro databázi
      datePickerMonth: '',
      datePickerYear: '',
      datePickerDay: '',
      datePickerDaysInMonth: [],
      datePickerBlankDaysInMonth: [],
      datePickerMonthNames: ['Leden', 'Únor', 'Březen', 'Duben', 'Květen', 'Červen', 'Červenec', 'Srpen', 'Září', 'Říjen', 'Listopad', 'Prosinec'],
      datePickerDays: ['Ne', 'Po', 'Út', 'St', 'Čt', 'Pá', 'So'],
      ...
      datePickerFormatDate(date) {
        let formattedDate = ('0' + date.getDate()).slice(-2); // Dvoučíselné datum
        ...
        return `${formattedYear}-${formattedMonthInNumber}-${formattedDate}`; // Výchozí formát
      },
    }" x-init="
        ...
        datePickerCalculateDays();
    " x-cloak>
    <div class="container py-2 mx-auto md:py-10 ">
        <div class="mb-5 w-[17rem]">
            <label for="datepicker" class="block mb-1 text-sm font-medium text-neutral-500">Vyberte si datum</label>
